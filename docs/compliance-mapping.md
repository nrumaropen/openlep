...
**Important context on the current federal landscape (added August 2026):** On March 1, 2025, Executive Order 14224 revoked EO 13166 and directed DOJ to rescind its 2002 LEP policy guidance, which DOJ did on March 21, 2025. DOJ separately rescinded the disparate-impact provisions of its Title VI regulations in December 2025. Title VI itself (42 U.S.C. § 2000d) is unchanged — federal funding recipients still have a legal, statutory obligation not to discriminate on the basis of national origin, and courts have long read that to include LEP access — but the operational federal guidance agencies previously relied on to interpret and size that obligation has been withdrawn, and no replacement guidance had been finalized as of this writing (interim guidance targeted for public comment by January 2026 per the Attorney General's July 2025 memorandum).

This is directly relevant to OpenLEP's rationale: with federal interpretive guidance withdrawn, public institutions now have *less* federal support in determining how to meet their continuing Title VI obligations, not more. A locally-owned, structured framework for tracking language access data and mapping it to statutory (not just guidance-level) obligations arguably becomes more valuable in this environment, not less — institutions can no longer lean on DOJ's four-factor test as an off-the-shelf compliance standard and may need to develop and document their own reasonable, defensible approach, which is exactly what a schema like this supports.
...
| 2 | EO-13166 | Improving Access to Services for LEP Persons | Executive Order 13166 (Aug. 11, 2000) | 2000-08-11 | **REVOKED 2025-03-01** | Formerly directed every federal agency to develop a plan to improve access for LEP persons. **Revoked by Executive Order 14224 ("Designating English as the Official Language of the United States"), March 1, 2025.** EO 14224 does not require agencies to stop existing language services, but removes the affirmative federal mandate to plan for LEP access. Retained here for historical/schema-design reference only — do not cite as current authority. |
| 2b | EO-14224 | Designating English as the Official Language of the United States | Executive Order 14224 (Mar. 1, 2025); 90 Fed. Reg. 11363 | 2025-03-01 | true | Current controlling executive order. Designates English as the official language, revokes EO 13166, and directs the Attorney General to rescind EO 13166-based guidance and issue updated guidance. Does not itself prohibit agencies from continuing to offer language services; agency heads retain discretion. |
| 3 | DOJ-LEP-GUIDANCE | DOJ Policy Guidance on Title VI and LEP (2002) | 67 Fed. Reg. 41455 (June 18, 2002) | 2002-06-18 | **RESCINDED 2025-03-21** | Formerly established the four-factor test (proportion of LEP persons served, frequency of contact, program importance, resources available) used to size "reasonable steps" under Title VI. **Rescinded by DOJ on March 21, 2025, consistent with EO 14224, and unpublished from the Civil Rights Division's website.** Retained here for historical/schema-design reference — the four-factor concept remains a useful internal analytical framework for OpenLEP even though it is no longer binding federal guidance. |
| 3b | AG-MEMO-2025 | Attorney General Memorandum Implementing EO 14224 ("Bondi Memo") | Memorandum for All Federal Agencies from the Attorney General (July 14, 2025) | 2025-07-14 | true | Current interim guidance directing agencies to review and rescind EO 13166-based materials not otherwise required by law, and instructing new guidance be issued for public comment (targeted January 10, 2026). Agencies should be monitored for finalized replacement guidance, which may supersede this row. |
...
| 4 | 3 (DOJ four-factor test — retained as internal methodology, no longer binding guidance) | `persons` + `language_needs` | `org_id`, `preferred_language_code` (aggregated) | Factor 1 & 2: proportion/frequency of LEP contact, by org and language | Annually | true |
| 5 | 3 (DOJ four-factor test — retained as internal methodology, no longer binding guidance) | `programs` | `program_type`, `funding_source` | Factor 3: nature/importance of the program (used to weight required resourcing) | Annually | false — narrative field, not purely derivable from data |
